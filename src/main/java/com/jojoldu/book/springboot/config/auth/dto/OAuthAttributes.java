...
import com.jojoldu.book.springboot.domain.usesr.Role;
import com.jojoldu.book.springboot.domain.usesr.User;
...
public class OAuthAttributes {
    ...
    public static OAuthAttributes of(String registrationIId, String userNameAttributeName,
                                     Map<String, Object> attributes){
        if ("naver".equals(registrationIId)) {
